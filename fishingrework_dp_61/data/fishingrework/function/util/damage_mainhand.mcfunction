...
#uid target is: 0000124a-0000-1ee9-0000-24db000138e4
#basic summon is summon armor_stand ~ ~ ~ {UUID:[I;4682,7913,9435,80100],NoGravity:1b,Invulnerable:1b,ShowArms:1b,Small:1b,Marker:1b,Invisible:1b,DisabledSlots:4144959}
...
item replace entity 0000124a-0000-1ee9-0000-24db000138e4 weapon.mainhand from entity @s weapon.mainhand

#get the current amount of damage done (0 = undamaged) to temp3
execute store result score #temp3 fr_data run data get entity 0000124a-0000-1ee9-0000-24db000138e4 HandItems[0].components.minecraft:damage 1

#get the max damage (0 on item mod = fully depleted durability = bigger number to damage)
item modify entity 0000124a-0000-1ee9-0000-24db000138e4 weapon.mainhand [{function:"set_damage",damage:0}]
execute store result score #temp4 fr_data run data get entity 0000124a-0000-1ee9-0000-24db000138e4 HandItems[0].components.minecraft:damage 1
