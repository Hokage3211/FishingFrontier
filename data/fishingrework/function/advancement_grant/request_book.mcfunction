...
recipe give @p fishingrework:angler_guide
...
execute store success storage fishingrework:data tempInt int 1 unless data storage fishingrework:data tempInt if predicate fishingrework:tier_unlocked/1 run give @p book 1
