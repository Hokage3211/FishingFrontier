...
execute store result score #maxCheck fr_data run data get entity @s Motion[0] 220
...
execute store result score #maxCheck fr_data run data get entity @s Motion[1] 130
scoreboard players operation #maxCheck fr_data < #900 fr_data
...
execute store result score #maxCheck fr_data run data get entity @s Motion[2] 220
scoreboard players operation #maxCheck fr_data < #900 fr_data
